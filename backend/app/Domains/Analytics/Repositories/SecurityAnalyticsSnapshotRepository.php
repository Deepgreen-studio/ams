...
class SecurityAnalyticsSnapshotRepository extends BaseRepository
{
    public function __construct(SecurityAnalyticsSnapshot $model)
    {
        parent::__construct($model);
    }

    public function upsertForDate(?int $companyId, Carbon $date, array $attributes): SecurityAnalyticsSnapshot
    {
        ...
        /** @var SecurityAnalyticsSnapshot $created */
