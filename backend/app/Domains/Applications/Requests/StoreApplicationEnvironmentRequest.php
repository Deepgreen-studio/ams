...
class StoreApplicationEnvironmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['required', Rule::in(ApplicationEnvironmentType::values())],
            'api_url' => ['nullable', 'url', 'max:500'],
            'web_url' => ['nullable', 'url', 'max:500'],
            'status' => ['nullable', Rule::in(ApplicationEnvironmentStatus::values())],
