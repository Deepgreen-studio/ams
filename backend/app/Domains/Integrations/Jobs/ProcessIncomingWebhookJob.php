...
use App\Domains\Integrations\Services\IncomingWebhookIngestService;
...
class ProcessIncomingWebhookJob implements ShouldQueue
{
    ...
    public function trackPayload(): array
    {
        return [
            ...
            'direction' => 'incoming_ingest',
        ];
    }

    public function handle(IncomingWebhookIngestService $ingestService): void
    {
        $ingestService->processLog($this->webhookLogId);
    }
}
