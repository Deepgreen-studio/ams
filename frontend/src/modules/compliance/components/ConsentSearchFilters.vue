...
} from '@/modules/compliance/utils/consentOptions';
...
const statusSelectOptions = [{ value: '', label: 'All statuses' }, ...consentStatusOptions];
const channelSelectOptions = [{ value: '', label: 'All channels' }, ...consentChannelOptions];
const sourceSelectOptions = [{ value: '', label: 'All sources' }, ...consentSourceOptions];
