...
import { policyStatusOptions, policyTypeOptions } from '@/modules/compliance/utils/policyOptions';
...
const statusSelectOptions = [{ value: '', label: 'All statuses' }, ...policyStatusOptions];
const typeSelectOptions = [{ value: '', label: 'All types' }, ...policyTypeOptions];
...
function onReset() {
  Object.assign(local, { search: '', status: '', policy_type: '' });
  emit('reset');
}
</script>
