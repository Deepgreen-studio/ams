<template>
  <div class="rounded-xl border border-slate-200 bg-white p-5">
    <div class="mb-4">
      <h3 class="text-sm font-semibold text-slate-900">Request timeline</h3>
      <p class="text-xs text-slate-500">Verification, approval, export, and completion history</p>
    </div>
    ...
    <EmptyState
      ...
      description="Workflow actions will appear here."
    />
