<template>
  <div>
    ...
    <div class="overflow-x-auto px-3">
        <table class="min-w-full text-sm">
          <thead>
            <tr class="border-b border-zinc-100">
              <th class="px-5 py-3 text-left text-sm font-semibold text-zinc-500">Tag</th>
      ...
      <tbody v-else-if="!taxonomy.tags.length">
            ...
            <tr>
              ...
              <EmptyState
                title="No tags found"
                description="Create CMS tags with SEO slugs, status, and sort order."
                >
                <template #action>
                </template>
              </EmptyState>
          ...
          <tbody v-else>
            ...
            >
              ...
              <td class="hidden px-5 py-4 text-slate-600 md:table-cell">{{ item.sort_order }}</td>
...
const activeItem = computed(
  () => taxonomy.tags.find((item) => item.uuid === openMenuId.value) || null,
);
